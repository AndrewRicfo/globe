...
var earthjs = (function () {
    ...
    var threejsPlugin = (function () {
        ...
        manager.onLoad = function () {
            ...
            if(parseInt(progressBar.style.width < 75)) {
            ...
            setTimeout(() => {
                ...
                document.querySelector('#globe').style.opacity = "1";
            }, 4400);
        };
    ...
    var worldCanvas = (function (worldUrl) {
        ...
        return {
            ...
            data: function data(_data) {
                // ACHTUNG! dolzhno zaiti syuda chtobi zasetit' coutries.features
                if (_data) {
                    _.world = _data;
                    _.countries.features = topojson.feature(_data, _data.objects.countries).features
                } else {
